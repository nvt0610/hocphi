...
\restrict NaNy91XnKupaaV1pSjzMg6TSeZE6yAo3VAqEgNHR3COIrJPL2KiO4HzQLufcpdK
...
CREATE TABLE public.classes (
    ...
    monthly_fee numeric(10,0) DEFAULT '0'::numeric NOT NULL
);
...
CREATE TABLE public.tuition_records (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    student_id uuid NOT NULL,
    amount numeric(10,0) DEFAULT '0'::numeric NOT NULL,
...
--
-- Name: IDX_8311cc83d9350de70f2a77e8c5; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IDX_8311cc83d9350de70f2a77e8c5" ON public.class_schedules USING btree (class_id);


--
-- Name: IDX_dce47b7f9b915c560a6f093992; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IDX_dce47b7f9b915c560a6f093992" ON public.class_schedules USING btree (day_of_week);
...
\unrestrict NaNy91XnKupaaV1pSjzMg6TSeZE6yAo3VAqEgNHR3COIrJPL2KiO4HzQLufcpdK
